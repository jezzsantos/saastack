...
/// <summary>
///     Consent for the user to authorize the OAuth2/OIDC client to access their data
/// </summary>
...
public class
    ConsentToOAuth2ClientForCallerRequest : UnTenantedRequest<ConsentToOAuth2ClientForCallerRequest,
