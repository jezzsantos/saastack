    ...
    public class GivenAConsumerClass
    {
        ...
        public void WhenDefinesAConsumer_ThenGenerates()
        {
            ...
            result.Should().Be(
                ...
                public sealed class DeliverDomainEventToaprojectnameANamespaceAConsumerClass
                {
                    ...
                    public DeliverDomainEventToaprojectnameANamespaceAConsumerClass(Infrastructure.Workers.Api.IMessageBusMonitoringApiRelayWorker<Application.Persistence.Shared.ReadModels.DomainEventingMessage> worker)
                    {
                        _worker = worker;
                    }
                
                    [Microsoft.Azure.Functions.Worker.Function(nameof(DeliverDomainEventToaprojectnameANamespaceAConsumerClass))]
                    ...
                    {
                        return _worker.RelayMessageOrThrowAsync("aprojectname", "aprojectname_ANamespace_AConsumerClass", message, context.CancellationToken);
                    }
                }
                ...
                public sealed class DeliverDomainEventToaprojectnameANamespaceAConsumerClass
                {
                    ...
                    {
                        return await AWSLambdas.Api.WorkerHost.Extensions.SqsEventExtensions.RelayRecordsAsync(sqsEvent, _worker, "aprojectname", "aprojectname_ANamespace_AConsumerClass", CancellationToken.None);
                    }
                }
                #endif
