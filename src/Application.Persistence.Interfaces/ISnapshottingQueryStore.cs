...
/// </summary>
public interface ISnapshottingQueryStore<TQueryableEntity>
    where TQueryableEntity : IQueryableEntity, new()
{
    ...
    /// </summary>
    Task<Result<QueryResults<TQueryableEntity>, Error>> QueryAsync(QueryClause<TQueryableEntity> query,
