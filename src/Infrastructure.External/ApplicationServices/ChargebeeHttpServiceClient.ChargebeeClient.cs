...
public interface IChargebeeClient
{
    ...
    /// <summary>
    ///     Returns a new <see cref="ChargeBee.Models.Customer" /> for the specified
    ///     <see cref="Application.Services.Shared.SubscriptionBuyer" />
    /// </summary>
    ...
    /// <summary>
    ///     Returns a new <see cref="ChargeBee.Models.PaymentSource" /> for the specified customer
    /// </summary>
    ...
    /// <summary>
    ///     Returns a new <see cref="ChargeBee.Models.Item" /> of the specified <see cref="ChargeBee.Models.Item.ItemType" />
    ...
    /// <summary>
    ///     Creates a new <see cref="ChargeBee.Models.ItemPrice" /> for the specified <see cref="itemId" /> for a
    ...
    /// <summary>
    ///     Creates a new <see cref="ChargeBee.Models.ItemFamily" /> with the specified <see cref="familyId" />
    /// </summary>
    Task<Result<Error>> CreateProductFamilyAsync(ICallerContext caller, string familyId,
        CancellationToken cancellationToken);

    /// <summary>
    ///     Returns a new <see cref="ChargeBee.Models.Subscription" /> for the specified
    ///     <see cref="ChargeBee.Models.Customer" />
    ...
    /// <summary>
    ///     Returns a new <see cref="ChargeBee.Models.Feature.TypeEnum.Switch" /> type <see cref="ChargeBee.Models.Feature" />
    ...
    /// <summary>
    ///     Returns all <see cref="ChargeBee.Models.ItemPrice" /> for all plans, charges and addOns, that are
    ///     <see cref="ChargeBee.Models.ItemPrice.StatusEnum.Active" />
    /// </summary>
    ...
    /// <summary>
    ///     Returns the <see cref="ChargeBee.Models.AttachedItem" /> for charges attached to a specified plan
    /// </summary>
    ...
    /// <summary>
    ///     Returns all <see cref="ChargeBee.Models.Entitlement" /> for the specified plan
    /// </summary>
    Task<Result<IReadOnlyList<Entitlement>, Error>> ListPlanEntitlementsAsync(ICallerContext caller,
        string planId, CancellationToken cancellationToken);

    /// <summary>
    ///     Returns all the optional (switch) <see cref="ChargeBee.Models.Feature" />
    /// </summary>
    ...
    /// <summary>
    ///     Removes the specified <see cref="ChargeBee.Models.Entitlement" /> from the specified
    ///     <see cref="ChargeBee.Models.Plan" />
    /// </summary>
    ...
    /// <summary>
    ///     Returns all <see cref="ChargeBee.Models.Feature" />
    /// </summary>
    ...
    /// <summary>
    ///     Returns all the items of the specified <see cref="ChargeBee.Models.Item.TypeEnum" />
    /// </summary>
    ...
    /// <summary>
    ///     Returns the updated <see cref="ChargeBee.Models.Customer" />
    /// </summary>
    Task<Result<Customer, Error>> UpdateCustomerForBuyerAsync(ICallerContext caller, string customerId,
        SubscriptionBuyer buyer, CancellationToken cancellationToken);

    /// <summary>
    ///     Returns the updated billing address for the specified <see cref="ChargeBee.Models.Customer" />
    /// </summary>
