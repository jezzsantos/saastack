...
///     <see cref="Common.Error.EntityNotFound(string?,System.Collections.Generic.Dictionary{string,object}?)" />
///     * When calling <see cref="IsEnabled(Flag)" /> for a flag that does not exist, we will return
///     <see cref="FlagEnabledWhenNotExists" />
///     * We never want to ask for the flag for the anonymous user (
///     <see cref="Domain.Interfaces.CallerConstants.AnonymousUserId" />)
