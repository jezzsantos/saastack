...
using NonFrameworkAnalyzers::Domain.Interfaces.ValueObjects;
using NonFrameworkAnalyzers::JetBrains.Annotations;
using Xunit;
using NonFramework_DomainDrivenDesignAnalyzer = NonFrameworkAnalyzers::Tools.Analyzers.NonFramework.DomainDrivenDesignAnalyzer;
    ...
    public static AggregateRootFactory<AClass> Rehydrate()
    {
        return (identifier, container, properties) => new AClass(container.GetRequiredService<IRecorder>(),
            container.GetRequiredService<IIdentifierFactory>(), identifier);
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule010, input, 11,
                    21,
                    "AClass");
            }
...
public sealed class EventOccurred : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule011, input, 33,
                    24,
...
public sealed class AClass : AggregateRootBase
{
    ...
    public static AClass Create()
    {
        return null!;
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule012, input, 32,
                    26,
                    "Create", NonFramework_DomainDrivenDesignAnalyzer.ConstructorMethodCall);
            }
...
public sealed class EventOccurred : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule013, input, 14,
                    12, "AClass");
            }
...
public sealed class EventOccurred : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule014, input, 8,
                    21,
                    "AClass");
            }
...
public sealed class EventOccurred : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule015, input, 14,
                    21, "AClass");
            }
...
public sealed class EventOccurred : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule016, input, 14,
                    21,
                    "AClass");
            }
...
public sealed class EventOccurred : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule017, input, 40,
                    19, "AProperty");
            }
...
public sealed class EventOccurred : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule018, input, 12,
                    14, "AClass");
            }
...
public sealed class AClass : EntityBase
{
    ...
    protected override Result<Error> OnStateChanged(IDomainEvent @event)
    {
        return Result.Ok;
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule020, input, 9,
                    21, "AClass");
            }
...
public sealed class AClass : EntityBase
{
    ...
    public static void Create()
    {
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule021, input, 21,
...
public sealed class AClass : EntityBase
{
    ...
    public static AClass Create()
    {
        return new AClass(null!, null!, null!);
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule022, input, 12,
                    12, "AClass");
            }
...
public sealed class AClass : EntityBase
{
    ...
    public override HydrationProperties Dehydrate()
    {
        return base.Dehydrate();
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule023, input, 16,
                    21, "AClass");
            }
...
public sealed class AClass : EntityBase
{
    ...
    public static EntityFactory<AClass> Rehydrate()
    {
        return (identifier, container, properties) => new AClass(identifier, container, properties);
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule024, input, 16,
                    21, "AClass");
            }
...
public sealed class AClass : EntityBase
{
    ...
    public static EntityFactory<AClass> Rehydrate()
    {
        return (identifier, container, properties) => new AClass(identifier, container, properties);
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule025, input, 15,
                    21,
                    "AClass");
            }
...
public sealed class AClass : EntityBase
{
    ...
    public string AProperty { get;set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule026, input, 27,
                    19, "AProperty");
            }
...
public class AClass : EntityBase
{
    ...
    public string AProperty { get; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule027, input, 11,
                    14, "AClass");
            }
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public string AProperty { get;}
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule030, input, 11,
                    21, "AClass");
            }
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public string AProperty { get;}
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule031, input, 19,
                    24, "Create", "ANamespace.AClass or Common.Result<ANamespace.AClass, Common.Error>");
            }
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public string AProperty { get;}
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule032, input, 14,
                    12, "AClass");
            }
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public string AProperty { get;}
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule033, input, 12,
                    21, "AClass");
            }
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public string AProperty { get;set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule034, input, 35,
                    19, "AProperty");
            }
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public void AMethod()
    {
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule035, input, 37,
                    17, "AMethod",
...
public class AClass : ValueObjectBase<AClass>
{
    ...
    public Result<AClass, Error> AMethod()
    {
        return null!;
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule036, input, 13,
                    14, "AClass");
            }
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public Result<AClass, Error> AMethod()
    {
        return null!;
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule037, input, 37,
...
public sealed class AClass : ValueObjectBase<AClass>
{
    ...
    public Result<AClass, Error> AMethod()
    {
        return null!;
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule038, input, 25,
...
internal sealed class AClassed : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule040, input, 5, 23, "AClassed");
            }
        }
...
public class AClassed : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule041, input, 5, 14, "AClassed");
            }
        }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule042, input, 5, 21, "AClassed");
            }
...
public sealed class AClass : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule043, input, 5, 21, "AClass");
            }
...
public sealed class AClassV2 : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule043, input, 5, 21, "AClassV2");
            }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public required DateTime OccurredUtc { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule045, input, 7, 26, "Create", "ANamespace.AClassed");
            }
        }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public string? AProperty { get; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule046, input, 20, 20, "AProperty", null);
            }
        }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public string AProperty { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule047, input, 20, 19, "AProperty");
            }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public DateTime AProperty { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule047, input, 20, 21, "AProperty");
            }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public required Optional<string> AProperty { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(input,
                    (NonFramework_DomainDrivenDesignAnalyzer.Rule048, 22, 38, "AProperty", null),
                    (NonFramework_DomainDrivenDesignAnalyzer.Rule049, 22, 38, "AProperty", [GivenRule049.AllTypes]));
            }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public required char AProperty { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule049, input, 21, 26, "AProperty", AllTypes);
            }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public required List<char> AProperty { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule049, input, 22, 32, "AProperty", AllTypes);
            }
...
public sealed class AClassed : IDomainEvent
{
    ...
    public required Dictionary<string, char> AProperty { get; set; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule049, input, 22, 46, "AProperty", AllTypes);
            }
...
public class ADto
{
    public string AProperty { get; }
                ...
                await Verify.DiagnosticExists<NonFramework_DomainDrivenDesignAnalyzer>(
                    NonFramework_DomainDrivenDesignAnalyzer.Rule049, input, 22, 26, "AProperty", AllTypes);
            }
