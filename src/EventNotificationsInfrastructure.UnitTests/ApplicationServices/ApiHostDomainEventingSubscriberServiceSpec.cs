...
public class ApiHostDomainEventingSubscriberServiceSpec
{
    ...
    public void WhenConstructed_ThenHasConsumers()
    {
        ...
        result[typeof(TestConsumer1)].Should().Be("ahostname_EventNotificationsInfrastructure_UnitTests_ApplicationServices_TestConsumer1");
        result[typeof(TestConsumer2)].Should().Be("ahostname_EventNotificationsInfrastructure_UnitTests_ApplicationServices_TestConsumer2");
    }
    ...
    public async Task WhenRegisterAllSubscribersAsync_ThenRegistersAll()
    {
        ...
        _store.Verify(store => store.SubscribeAsync(EventingConstants.Topics.DomainEvents, "ahostname_EventNotificationsInfrastructure_UnitTests_ApplicationServices_TestConsumer1", It.IsAny<CancellationToken>()));
    }
}
