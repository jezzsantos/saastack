...
public class OAuth2ClientSecretsSpec
{
    ...
    {
        var secret1 = OAuth2ClientSecret.Create("asecrethash1", Optional<DateTime>.None).Value;
        var secret2 = OAuth2ClientSecret.Create("asecrethash2", Optional<DateTime>.None).Value;
        var secret3 = OAuth2ClientSecret.Create("asecrethash3", Optional<DateTime>.None).Value;
    ...
    {
        var secret = OAuth2ClientSecret.Create("asecrethash1", DateTime.UtcNow.SubtractSeconds(1)).Value;
