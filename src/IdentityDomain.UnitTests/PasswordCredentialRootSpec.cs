...
public class PasswordCredentialRootSpec
{
        ...
        WhenChangeMfaOptionsWithDisabledAndExistingAuthenticators_ThenDissociatesAuthenticatorsAndDisables()
    {
        ...
        credential.VerifyRegistration();
        credential.SetPasswordCredential("apassword");
        await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.OobSms,
            PhoneNumber.Create("+6498876986").Value, Optional<EmailAddress>.None, Optional<EmailAddress>.None,
            _ => Task.FromResult(Result.Ok));
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(),
        ...
        credential.Events[11].Should().BeOfType<MfaAuthenticatorRemoved>();
    ...
    [Fact]
    public void WhenMfaAuthenticateAndNotVerified_ThenReturnsError()
    {
        _credential.InitiateRegistrationVerification();

        var result = _credential.MfaAuthenticate(false, "atoken");
    ...
    [Fact]
    public void WhenMfaAuthenticateAndNoPassword_ThenReturnsError()
    {
        _credential.SetRegistrationDetails(EmailAddress.Create("auser@company.com").Value,
            PersonDisplayName.Create("aname").Value);
        _credential.InitiateRegistrationVerification();
    ...
    [Fact]
    public void WhenMfaAuthenticateByUnauthenticatedUserAndToken_ThenReturns()
    {
        _tokensService.Setup(ts => ts.CreateMfaAuthenticationToken())
            .Returns("atoken");
        _credential.SetRegistrationDetails(EmailAddress.Create("auser@company.com").Value,
    ...
    [Fact]
    public void WhenMfaAuthenticateByAuthenticatedUser_ThenReturns()
    {
        _tokensService.Setup(ts => ts.CreateMfaAuthenticationToken())
            .Returns("atoken");
        _credential.SetRegistrationDetails(EmailAddress.Create("auser@company.com").Value,
        ...
        var result = _credential.MfaAuthenticate(true, Optional<string>.None);
    ...
    {
        var result = _credential.DisassociateMfaAuthenticator("anotheruserid".ToId(), "anauthenticatorid".ToId());
    ...
    public void WhenDisassociateMfaAuthenticatorAndIsNotVerified_ThenReturnsError()
    {
        ...
        var result = _credential.DisassociateMfaAuthenticator("auserid".ToId(), "anauthenticatorid".ToId());
    ...
    public async Task WhenDisassociateMfaAuthenticatorAndIsRecoveryCodes_ThenReturnsError()
    {
        ...
        _credential.SetPasswordCredential("apassword");
        _credential.ChangeMfaEnabled("auserid".ToId(), true);
        await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
        ...
        var result = _credential.DisassociateMfaAuthenticator("auserid".ToId(), recoveryCodes.Value.Id);
    ...
    public async Task WhenDisassociateMfaAuthenticatorAndNotLastOne_ThenDeletesAuthenticator()
    {
        ...
        _credential.SetPasswordCredential("apassword");
        _credential.ChangeMfaEnabled("auserid".ToId(), true);
        var authenticator1 = (await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<PhoneNumber>.None, Optional<EmailAddress>.None,
            EmailAddress.Create("auser@company.com").Value, _ => Task.FromResult(Result.Ok))).Value;
        var authenticator2 = (await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
        ...
        var result = _credential.DisassociateMfaAuthenticator("auserid".ToId(), authenticator2.Id);
    ...
    public async Task WhenDisassociateMfaAuthenticatorAndLastOne_ThenDeletesAuthenticatorAndRecoveryCodes()
    {
        ...
        _credential.SetPasswordCredential("apassword");
        _credential.ChangeMfaEnabled("auserid".ToId(), true);
        var authenticator = (await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<PhoneNumber>.None, Optional<EmailAddress>.None,
            EmailAddress.Create("auser@company.com").Value, _ => Task.FromResult(Result.Ok))).Value;

        var result = _credential.DisassociateMfaAuthenticator("auserid".ToId(), authenticator.Id);
    ...
    {
        var result = await _credential.AssociateMfaAuthenticatorAsync(false, "anotheruserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<PhoneNumber>.None, Optional<EmailAddress>.None,
            EmailAddress.Create("auser@company.com").Value, _ => Task.FromResult(Result.Ok));
    ...
    public async Task WhenAssociateMfaAuthenticatorAndIsNotVerified_ThenReturnsError()
    {
        ...
        var result = await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<PhoneNumber>.None, Optional<EmailAddress>.None,
            EmailAddress.Create("auser@company.com").Value, _ => Task.FromResult(Result.Ok));
    ...
    [Fact]
    public async Task WhenAssociateMfaAuthenticatorAndConfirmedAuthenticatorAlreadyExists_ThenReturnsError()
    {
        _credential.SetRegistrationDetails(EmailAddress.Create("auser@company.com").Value,
            PersonDisplayName.Create("aname").Value);
        _credential.InitiateRegistrationVerification();
        ...
        await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<PhoneNumber>.None, Optional<EmailAddress>.None,
            EmailAddress.Create("auser@company.com").Value, _ => Task.FromResult(Result.Ok));
        _credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.TotpAuthenticator,
        ...
        result.Should().BeError(ErrorCode.PreconditionViolation,
            Resources.PasswordCredentialRoot_AssociateMfaAuthenticator_AlreadyExists);
    }
        ...
        WhenAssociateMfaAuthenticatorByAuthenticatedUserAndAnotherAuthenticatorIsAlreadyAssociated_ThenAssociatesAuthenticator()
    {
        ...
        var result = await _credential.AssociateMfaAuthenticatorAsync(true, "auserid".ToId(),
    ...
    public async Task WhenReAssociateMfaAuthenticatorThenUpdatesAssociation()
    {
        ...
        _credential.SetPasswordCredential("apassword");
        _credential.ChangeMfaEnabled("auserid".ToId(), true);
        await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.OobSms,
    ...
    {
        var result = _credential.ConfirmMfaAuthenticatorAssociation("anotheruserid".ToId(),
    ...
    public void WhenConfirmMfaAuthenticatorAssociationAndIsNotVerified_ThenReturnsError()
    {
        ...
        var result = _credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<string>.None, Optional<string>.None);
    ...
    public async Task WhenConfirmMfaAuthenticatorAssociationForOobEmail_ThenConfirms()
    {
        ...
        _credential.ChangeMfaEnabled("auserid".ToId(), true);
        _credential.InitiateMfaAuthentication();
        await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.OobEmail,
    ...
    {
        var result = await _credential.ChallengeMfaAuthenticatorAsync("anotheruserid".ToId(),
    ...
    public async Task WhenChallengeMfaAuthenticatorAsyncAndIsNotVerified_ThenReturnsError()
    {
        ...
        var result = await _credential.ChallengeMfaAuthenticatorAsync("auserid".ToId(),
            "anauthenticatorid".ToId(), _ => Task.FromResult(Result.Ok));
    ...
    public async Task WhenChallengeMfaAuthenticatorAsyncForOobSms_ThenChallenges()
    {
        ...
        await _credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.OobSms,
            PhoneNumber.Create("+6498876986").Value, Optional<EmailAddress>.None, Optional<EmailAddress>.None,
            _ => Task.FromResult(Result.Ok));
        _credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(),
            MfaAuthenticatorType.OobSms, "anoobcode", "anoobsecret");
        var wasCalled = false;
    ...
    {
        var result = _credential.VerifyMfaAuthenticator(true, "auserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<string>.None, Optional<string>.None);
    ...
    {
        var result = _credential.VerifyMfaAuthenticator(false, "anotheruserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<string>.None, Optional<string>.None);
    ...
    public void WhenVerifyMfaAuthenticatorAndIsNotVerified_ThenReturnsError()
    {
        ...
        var result = _credential.VerifyMfaAuthenticator(false, "auserid".ToId(),
            MfaAuthenticatorType.TotpAuthenticator, Optional<string>.None, Optional<string>.None);
