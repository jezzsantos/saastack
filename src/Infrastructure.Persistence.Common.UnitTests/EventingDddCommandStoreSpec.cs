...
public class EventingDddCommandStoreSpec
{
    ...
    public EventingDddCommandStoreSpec()
    {
        ...
        _store =
            new EventingDddCommandStore<TestEventingAggregateRoot>(recorder.Object, _domainFactory.Object,
                migrator.Object, _eventStore.Object);

        _eventStreamChangedArgs = null;
        _store.OnEventStreamChanged += (_, args) => { _eventStreamChangedArgs = args; };
    }
    ...
    public async Task WhenLoadAndPreviouslyTombstoned_ThenReturnsError()
    {
        ...
        result.Should().BeError(ErrorCode.EntityNotFound, Resources.EventingDddCommandStore_StreamTombstoned);
    }
    ...
    public async Task WhenSaveAndAggregateHasNoIdentifier_ThenReturnsError()
    {
        ...
        result.Should().BeError(ErrorCode.EntityExists,
            Resources.EventingDddCommandStore_SaveWithAggregateIdMissing);
    }
