...
[Trait("Category", "Unit")]
public class SnapshottingDddQueryStoreSpec
{
    private readonly Mock<IDataStore> _dataStore;
    private readonly SnapshottingDddQueryStore<TestQueryEntity> _store;

    public SnapshottingDddQueryStoreSpec()
    {
        var recorder = new Mock<IRecorder>();
        var domainFactory = new Mock<IDomainFactory>();
        _dataStore = new Mock<IDataStore>();
        _store =
            new SnapshottingDddQueryStore<TestQueryEntity>(recorder.Object, domainFactory.Object,
                _dataStore.Object);
    }
