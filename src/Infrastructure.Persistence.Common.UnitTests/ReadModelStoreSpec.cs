...
public class ReadModelStoreSpec
{
    ...
    {
        var result =
            await _store.CreateAsync("anid", entity => entity.APropertyName = "avalue", CancellationToken.None);
    ...
    public async Task WhenUpdateAndNotExists_ThenReturnsError()
    {
        ...
        var result =
            await _store.UpdateAsync("anid", entity => entity.APropertyName = "avalue", CancellationToken.None);
