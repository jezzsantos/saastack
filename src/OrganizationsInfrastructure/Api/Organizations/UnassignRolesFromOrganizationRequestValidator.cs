...
public class UnassignRolesFromOrganizationRequestValidator : AbstractValidator<UnassignRolesFromOrganizationRequest>
{
    public UnassignRolesFromOrganizationRequestValidator(IIdentifierFactory identifierFactory)
    {
        RuleFor(req => req.Id)
