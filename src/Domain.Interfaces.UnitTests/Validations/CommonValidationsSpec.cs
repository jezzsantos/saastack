...
[Trait("Category", "Unit")]
public class CommonValidationsSpec
{
    [Fact]
    ...
    [Fact]
    public void WhenBase64WithNoPadding_ThenReturnsTrue()
    {
        var bytes = new byte[] { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06 };
        var value = Convert.ToBase64String(bytes);

        var result = CommonValidations.Base64()
            .Matches(value);
    ...
    [Fact]
    public void WhenBase64WithOnePadding_ThenReturnsTrue()
    {
    ...
    [Fact]
    public void WhenBase64WithTwoPadding_ThenReturnsTrue()
    {
