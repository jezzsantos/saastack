...
public class PasswordCredentialsApplicationMfaSpec
{
    ...
    public async Task WhenDisassociateMfaAuthenticatorAsync_ThenDeletes()
    {
        ...
        credential.ChangeMfaEnabled("auserid".ToId(), true);
        credential.InitiateMfaAuthentication();
        var authenticator = await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
    ...
    public async Task WhenConfirmMfaAuthenticatorAssociationAsyncByAnonymousForTotp_ThenConfirms()
    {
        ...
        credential.ChangeMfaEnabled("auserid".ToId(), true);
        credential.InitiateMfaAuthentication();
        await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.TotpAuthenticator,
    ...
    public async Task WhenConfirmMfaAuthenticatorAssociationAsyncByAuthenticatedUserForOobEmail_ThenConfirms()
    {
        ...
        credential.ChangeMfaEnabled("auserid".ToId(), true);
        credential.InitiateMfaAuthentication();
        await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.OobEmail,
    ...
    [Fact]
    public async Task WhenChallengeMfaAuthenticatorAsyncByAnonymousAndNoMfaToken_ThenReturnsError()
    {
        _caller.Setup(cc => cc.IsAuthenticated)
            .Returns(false);

        var result =
            await _application.ChallengeMfaAuthenticatorAsync(_caller.Object, null,
    ...
    public async Task WhenChallengeMfaAuthenticatorAsyncByAnonymousForTotpAuthenticator_ThenChallenges()
    {
        ...
        await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.TotpAuthenticator,
            Optional<PhoneNumber>.None, Optional<EmailAddress>.None, EmailAddress.Create("auser@company.com").Value,
            _ => Task.FromResult(Result.Ok));
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.TotpAuthenticator,
    ...
    public async Task WhenChallengeMfaAuthenticatorAsyncByAnonymousForOobSms_ThenChallenges()
    {
        ...
        await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.OobSms,
            PhoneNumber.Create("+6498876986").Value, Optional<EmailAddress>.None, Optional<EmailAddress>.None,
            _ => Task.FromResult(Result.Ok));
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.OobSms,
    ...
    public async Task WhenChallengeMfaAuthenticatorAsyncByAnonymousForOobEmail_ThenChallenges()
    {
        ...
        await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.OobEmail,
            Optional<PhoneNumber>.None, EmailAddress.Create("auser@company.com").Value, Optional<EmailAddress>.None,
            _ => Task.FromResult(Result.Ok));
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.OobEmail,
            "anoobcode", "anoobsecret");
        _repository.Setup(s =>
                s.FindCredentialsByMfaAuthenticationTokenAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(credential.ToOptional());
    ...
    public async Task WhenVerifyMfaAuthenticatorAsyncByAuthenticatedUserForRecoveryCodes_ThenConfirms()
    {
        ...
        credential.ChangeMfaEnabled("auserid".ToId(), true);
        credential.InitiateMfaAuthentication();
        //We need to create another authenticator to get recoverycodes created
        await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(), MfaAuthenticatorType.TotpAuthenticator,
            Optional<PhoneNumber>.None, Optional<EmailAddress>.None, EmailAddress.Create("auser@company.com").Value,
            _ => Task.FromResult(Result.Ok));
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.TotpAuthenticator, null,
            "aconfirmationcode");
        _repository.Setup(s =>
                s.FindCredentialsByMfaAuthenticationTokenAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(credential.ToOptional());
    ...
    public async Task WhenVerifyMfaAuthenticatorAsyncByAuthenticatedUserForTotp_ThenConfirms()
    {
        ...
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.TotpAuthenticator, null,
            "aconfirmationcode");
        await credential.ChallengeMfaAuthenticatorAsync("auserid".ToId(), authenticator.Value.Id,
            _ => Task.FromResult(Result.Ok));
        _repository.Setup(s =>
                s.FindCredentialsByMfaAuthenticationTokenAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(credential.ToOptional());
    ...
    public async Task WhenVerifyMfaAuthenticatorAsyncByAuthenticatedUserForOobSms_ThenConfirms()
    {
        ...
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.OobSms, "anoobcode",
            "anoobsecret");
        await credential.ChallengeMfaAuthenticatorAsync("auserid".ToId(), authenticator.Value.Id,
            _ => Task.FromResult(Result.Ok));
        _repository.Setup(s =>
    ...
    public async Task WhenVerifyMfaAuthenticatorAsyncByAuthenticatedUserForOobEmail_ThenConfirms()
    {
        ...
        var authenticator = await credential.AssociateMfaAuthenticatorAsync(false, "auserid".ToId(),
            ...
            _ => Task.FromResult(Result.Ok));
        credential.ConfirmMfaAuthenticatorAssociation("auserid".ToId(), MfaAuthenticatorType.OobEmail, "anoobcode",
            "anoobsecret");
        await credential.ChallengeMfaAuthenticatorAsync("auserid".ToId(), authenticator.Value.Id,
            _ => Task.FromResult(Result.Ok));
        _repository.Setup(s =>
