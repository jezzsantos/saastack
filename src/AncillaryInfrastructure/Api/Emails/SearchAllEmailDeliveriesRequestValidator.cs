...
public class SearchAllEmailDeliveriesRequestValidator : AbstractValidator<SearchAllEmailDeliveriesRequest>
{
    public SearchAllEmailDeliveriesRequestValidator(IIdentifierFactory identifierFactory)
    {
