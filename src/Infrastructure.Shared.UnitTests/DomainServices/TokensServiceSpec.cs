...
public class TokensServiceSpec
{
    ...
    {
        var result1 = _service.CreateOAuthAuthorizationCode("avalue");
        var result2 = _service.CreateOAuthAuthorizationCode("avalue");
        var result3 = _service.CreateOAuthAuthorizationCode("avalue");
