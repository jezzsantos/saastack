...
{
    Task<Result<PasswordCredentialMfaAssociation, Error>> AssociateMfaAuthenticatorAsync(
    ...
    Task<Result<PasswordCredentialMfaChallenge, Error>> ChallengeMfaAuthenticatorAsync(ICallerContext caller,
    ...
    Task<Result<PasswordCredentialMfaConfirmation, Error>> ConfirmMfaAuthenticatorAssociationAsync(
