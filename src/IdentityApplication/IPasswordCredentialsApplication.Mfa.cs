...
{
    Task<Result<AssociatedPasswordCredentialMfaAuthenticator, Error>> AssociateMfaAuthenticatorAsync(
    ...
    Task<Result<PasswordCredentialChallenge, Error>> ChallengeMfaAuthenticatorAsync(ICallerContext caller,
    ...
    Task<Result<AuthenticateTokens, Error>> ConfirmMfaAuthenticatorAssociationAsync(ICallerContext caller,
