...
public partial class PersonCredentialsApplication : IPersonCredentialsApplication
{
    ...
    public PersonCredentialsApplication(IRecorder recorder, IIdentifierFactory identifierFactory,
    ...
    private PersonCredentialsApplication(IRecorder recorder, IIdentifierFactory identifierFactory,
        IEndUsersService endUsersService, IUserProfilesService userProfilesService,
        IUserNotificationsService userNotificationsService,
        IConfigurationSettings settings,
        IEmailAddressService emailAddressService, ITokensService tokensService, IEncryptionService encryptionService,
    ...
    {
        var retrieved = await _repository.FindCredentialByUserIdAsync(caller.CallerId.ToId(), cancellationToken);
...
internal static class PersonCredentialConversionExtensions
{
