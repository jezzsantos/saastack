...
namespace Tools.Generators.Web.Api.Extensions;
...
public static class SymbolExtensions
{
    ...
    public static List<AttributeData> GetAttributes(this ISymbol symbol, INamedTypeSymbol attributeType)
    {
        return symbol.GetAttributes()
            .Where(attribute => attribute.AttributeClass!.IsOfType(attributeType))
            .ToList();
    }
