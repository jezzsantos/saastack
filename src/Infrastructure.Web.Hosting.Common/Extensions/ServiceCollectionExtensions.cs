...
public static class ServiceCollectionExtensions
{
        ...
        where TImplementation : class, TService1, TService2, TService3, TService4
    {
        ...
        services.RegisterLifetime(scope, implementationFactory);
        services.RegisterLifetime(scope, typeof(TService1), c => c.Resolve<TImplementation>());
        services.RegisterLifetime(scope, typeof(TService2), c => c.Resolve<TImplementation>());
        services.RegisterLifetime(scope, typeof(TService3), c => c.Resolve<TImplementation>());
        services.RegisterLifetime(scope, typeof(TService4), c => c.Resolve<TImplementation>());

        return services;
    }

    /// <summary>
    ///     Registers an instance of the <see cref="TService" /> as a <see cref="IPlatformDependency{TService}" />
        ...
        where TImplementation : class, TService1, TService2, TService3, TService4
    {
        ...
        services.RegisterPlatform(implementationFactory);
        ...
        where TImplementation : class, TService1, TService2, TService3, TService4
    {
        ...
        services.RegisterTenanted(implementationFactory);
        services.RegisterTenanted(typeof(TService1), c => c.ResolveForTenant<TImplementation>());
        services.RegisterTenanted(typeof(TService2), c => c.ResolveForTenant<TImplementation>());
        services.RegisterTenanted(typeof(TService3), c => c.ResolveForTenant<TImplementation>());
        services.RegisterTenanted(typeof(TService4), c => c.ResolveForTenant<TImplementation>());
        ...
        where TImplementation : class, TService1, TService2
    {
        ...
        services.RegisterUnshared(implementationFactory);
        services.RegisterUnshared(typeof(TService1), c => c.ResolveForUnshared<TImplementation>());
        services.RegisterUnshared(typeof(TService2), c => c.ResolveForUnshared<TImplementation>());
        ...
        where TImplementation : class, TService1, TService2, TService3
    {
        ...
        services.RegisterUnshared(typeof(TService1), c => c.ResolveForUnshared<TImplementation>());
        services.RegisterUnshared(typeof(TService2), c => c.ResolveForUnshared<TImplementation>());
        services.RegisterUnshared(typeof(TService3), c => c.ResolveForUnshared<TImplementation>());
        ...
        where TImplementation : class, TService1, TService2, TService3, TService4
    {
        ...
        services.RegisterUnshared(typeof(TService2), c => c.ResolveForUnshared<TImplementation>());
        services.RegisterUnshared(typeof(TService3), c => c.ResolveForUnshared<TImplementation>());
        services.RegisterUnshared(typeof(TService4), c => c.ResolveForUnshared<TImplementation>());
        ...
        where TImplementation : class, TService1, TService2, TService3, TService4, TService5
    {
        ...
        services.RegisterUnshared(typeof(TService3), c => c.ResolveForUnshared<TImplementation>());
        services.RegisterUnshared(typeof(TService4), c => c.ResolveForUnshared<TImplementation>());
        services.RegisterUnshared(typeof(TService5), c => c.ResolveForUnshared<TImplementation>());
