...
public class NativeIdentityServerProvider : IIdentityServerProvider
{
    public NativeIdentityServerProvider(IRecorder recorder, IIdentifierFactory identifierFactory,
        ...
        IOidcAuthorizationRepository oidcAuthorizationRepository)
    {
        ...
        OpenIdConnectService =
            new NativeIdentityServerOpenIdConnectService(recorder, identifierFactory, tokensService, websiteUiService,
                oauth2ClientService, authTokensService, endUsersService, userProfilesService,
