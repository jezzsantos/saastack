...
public class OAuth2Api : IWebApiService
{
    ...
    public async Task<ApiPostResult<OpenIdConnectTokens, CreateOAuthTokenResponse>> CreateToken(
        CreateOAuth2TokenRequest request, CancellationToken cancellationToken)
    {
        ...
        return () => token.HandleApplicationResult<OpenIdConnectTokens, CreateOAuthTokenResponse>(tok =>
            new PostResult<CreateOAuthTokenResponse>(new CreateOAuthTokenResponse
            {
