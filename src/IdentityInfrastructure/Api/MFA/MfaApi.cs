...
public class MfaApi : IWebApiService
{
    ...
    public async
        Task<ApiPostResult<PasswordCredentialMfaAssociation,
            ...
            AssociatePasswordMfaAuthenticatorForCallerRequest request, CancellationToken cancellationToken)
    {
        ...
        return () =>
            authenticator
                .HandleApplicationResult<PasswordCredentialMfaAssociation,
    ...
    public async
        Task<ApiPutPatchResult<PasswordCredentialMfaChallenge, ChallengePasswordMfaAuthenticatorForCallerResponse>>
            ...
            ChallengePasswordMfaAuthenticatorForCallerRequest request, CancellationToken cancellationToken)
    {
        ...
        return () =>
            challenge
                .HandleApplicationResult<PasswordCredentialMfaChallenge,
    ...
    public async
        Task<ApiPutPatchResult<PasswordCredentialMfaConfirmation, ConfirmPasswordMfaAuthenticatorForCallerResponse>>
            ...
            ConfirmPasswordMfaAuthenticatorForCallerRequest request, CancellationToken cancellationToken)
    {
        ...
        return () =>
            tokensOrAuthenticators
                .HandleApplicationResult<PasswordCredentialMfaConfirmation,
