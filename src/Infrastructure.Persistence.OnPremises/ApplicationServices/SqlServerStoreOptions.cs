...
{
    private const string DbCredentialsFormatSettingName = "ApplicationServices:Persistence:{0}:DbCredentials";
    private const string DbNameFormatSettingName = "ApplicationServices:Persistence:{0}:DbName";
    private const string DbServerNameFormatSettingName = "ApplicationServices:Persistence:{0}:DbServerName";
    private const string DefaultPrefix = "SqlServer";
    private const string ManagedIdentityClientIdFormatSettingName =
