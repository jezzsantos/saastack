...
public class EmailNotificationsService : INotificationsService
{
    ...
    private readonly IEmailQueuingService _emailQueuingService;
    ...
    public EmailNotificationsService(IConfigurationSettings settings, IHostSettings hostSettings,
        IWebsiteUiService websiteUiService, IEmailQueuingService emailQueuingService)
    {
        _hostSettings = hostSettings;
        _websiteUiService = websiteUiService;
        _emailQueuingService = emailQueuingService;
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _emailQueuingService.SendHtmlEmail(caller, new HtmlEmail
        {
