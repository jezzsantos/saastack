...
> Throwing exceptions can also be argued to be a `GOTO` statement, or some even like to ascribe it to a [`COMEFROM`](https://en.wikipedia.org/wiki/COMEFROM) statement for a entertainment.
