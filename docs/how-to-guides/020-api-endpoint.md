...
>
> `ApiEmptyResult` - can be used instead of any of the other kinds to denote an API that does not return any data in the result. (i.e., an `HTTP 204 - No Content`)
>
...
1. The class derives from `WebApiSpec<Program>` this is necessary to launch your API code into the a test harness for testing APIs.
